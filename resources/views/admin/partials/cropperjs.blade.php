<link rel="stylesheet" type="text/css" href="{{URL::to('back/bower_components/cropperjs/dist/cropper.css')}}">
<script src="{{URL::to('back/bower_components/cropperjs/dist/cropper.min.js')}}"></script>
<script src="{{URL::to('back/js/cropper.js')}}"></script>
<script>
    function readFile() {
        var input = $(this);
        if (input.data('ratio')) {

    ...
    <div class="col-md-12">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-gray-800">Update Branch</h3>
                </div>
            ...
            <!-- form start -->
            <form id="form" role="form" action="{{ route('v2.admin.branches.update', $branch->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    <!-- Row 1 -->
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="title" type="text" name="title" value="{{ old('title', $branch->title) }}">
                            @if ($errors->has('title'))
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="email">Primary Email<span
                                    class="text-red-500">*</span></label>
                            <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="email" type="text" name="email" value="{{ old('email', $branch->email) }}">
                            @if ($errors->has('email'))
                        ...
                        <div>
                            ...
                            <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="email_2" type="text" name="email_2" value="{{ old('email_2', $branch->email_2) }}">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="phone">Primary Contact<span
                                    class="text-red-500">*</span></label>
                            <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="phone" type="text" name="phone" value="{{ old('phone', $branch->phone) }}">
                            @if ($errors->has('phone'))
                        ...
                        <div>
                            ...
                            <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="phone_2" type="text" name="phone_2"
                                value="{{ old('phone_2', $branch->phone_2) }}">
                    ...
                    <div>
                        ...
                        <textarea class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm ckeditor" id="description"
                            name="description" rows="3">{{ old('description', $branch->description) }}</textarea>

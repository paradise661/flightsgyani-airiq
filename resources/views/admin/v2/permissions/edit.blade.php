    ...
    <div class="col-md-12">
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                <!-- Heading -->
                <h3 class="text-lg font-semibold text-gray-800">Update Permission</h3>
                <!-- Back Button -->
            ...
            <!-- Form Start -->
            <form id="form" action="{{ route('v2.admin.permissions.update', $permission->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    <!-- Title Field -->
                    <div>
                        ...
                        <input
                            ...
                            id="name" type="text" name="name" value="{{ old('name', $permission->name) }}"
                ...
                <div class="mt-2">
                    ...
                    <input
                        ...
                        id="parent" type="text" name="parent" value="{{ old('parent', $permission->parent) }}"

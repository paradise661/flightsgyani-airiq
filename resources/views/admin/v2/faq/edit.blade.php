    ...
    <div class="col-md-12">
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                <!-- Heading -->
                <h3 class="text-lg font-semibold text-gray-800">Update FAQ</h3>
                <!-- Back Button -->
            ...
            <!-- Form Start -->
            <form id="form" action="{{ route('v2.admin.faqs.update', $faq->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    <!-- Title Field -->
                    <div>
                        ...
                        <input
                            ...
                            id="title" type="text" name="title" value="{{ old('title', $faq->title) }}"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            id="content" name="content" rows="4" placeholder="Enter content">{{ old('content', $faq->content) }}</textarea>
                        @error('content')
                            <span class="text-sm text-red-500">*{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="order" type="number" name="order" value="{{ old('order', $faq->order) }}"

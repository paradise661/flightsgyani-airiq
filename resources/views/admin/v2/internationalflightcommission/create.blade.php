...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <!-- form start -->
            <form id="form" role="form" action="{{ route('v2.admin.commissions.store') }}"
                method="POST">
                @csrf
                <div class="space-y-6">
                    <!-- Row 1: Name -->
                            ...
                            <select
                                ...
                                @foreach ($airlines as $airline)
                                    <option value="{{ $airline->id ?? '' }}"
                                        {{ old('international_airline_id') == $airline->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                    ...
                                    value="{{ old('agent_child_commission') }}">
                            ...
                            <div>
                                ...
                                <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                    ...
                                    value="{{ old('agent_infant_commission') }}">

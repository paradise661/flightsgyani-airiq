...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <!-- form start -->
            <form id="form" role="form" action="{{ route('v2.admin.domestic.commissions.update', $commission->id) }}"
                method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                            ...
                            <select
                                ...
                                @foreach ($airlines as $airline)
                                    <option value="{{ $airline->id ?? '' }}"
                                        {{ $commission->domestic_airline_id == $airline->id ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input min="1" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="commission" type="number" name="commission"
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input min="1" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="agent_commission" type="number" name="agent_commission"
                                value="{{ $commission->agent_commission ?? '' }}">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <select
                                ...
                                <option {{ $commission->status == 1 ? 'selected' : '' }} value="1">Active</option>
                                <option {{ $commission->status == 0 ? 'selected' : '' }} value="0">Inactive</option>
                            </select>
                            @error('status')

    ...
    <div class="col-md-12">
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                <!-- First Heading (Add New team) -->
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-gray-800">Update Team</h3>
                </div>
                <!-- Back Button -->
                <div class="flex-none">
            ...
            <!-- Form Start -->
            <form id="form" role="form" action="{{ route('v2.admin.teams.update', $team->id) }}" method="POST"
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="name" type="text" name="name" value="{{ old('name', $team->name) }}"
                        ...
                        <!-- Link Field -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="position">Position<span
                                    class="text-red-500">*</span></label>
                            <input
                                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm @error('position') border-red-500 @enderror"
                                id="position" type="text" name="position" value="{{ old('position', $team->position) }}"
                    ...
                    <div class="grid grid-cols-3 gap-6">
                        <!-- Facebook Field -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="fb">Facebook</label>
                            <input
                                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm @error('fb') border-red-500 @enderror"
                                id="fb" type="text" name="fb" value="{{ old('fb', $team->fb) }}"
                        ...
                        <!-- Twitter Field -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="twitter">Twitter</label>
                            <input
                                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm @error('twitter') border-red-500 @enderror"
                                id="twitter" type="text" name="twitter" value="{{ old('twitter', $team->twitter) }}"
                        ...
                        <div>
                            ...
                            <input
                                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm @error('instagram') border-red-500 @enderror"
                                id="instagram" type="text" name="instagram"
                                value="{{ old('instagram', $team->instagram) }}" placeholder="Enter Instagram URL">
                            @error('instagram')
                                <span class="text-sm text-red-500">*{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            id="short_description" name="short_description" rows="3" placeholder="Enter a short description">{{ old('short_description', $team->short_description) }}</textarea>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="order" type="number" name="order" value="{{ old('order', $team->order) }}"
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @if ($team->image)
                                <img class="mt-2 old-image" src="{{ asset('uploads/team/' . $team->image) }}"
                                    width="100">
                                <i class="fa fa-times text-danger remove-image cursor-pointer" column="image"
                                    module="{{ $team->id }}" aria-hidden="true"></i>
                            @endif

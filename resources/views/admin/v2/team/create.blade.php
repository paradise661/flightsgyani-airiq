    ...
    <div class="col-md-12">
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-gray-800">Add New Team</h3>
                </div>
                <!-- Back Button -->
                <div class="flex-none">
            ...
            <!-- Form Start -->
            <form id="form" role="form" action="{{ route('v2.admin.teams.store') }}" method="POST"
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="position" type="text" name="position" value="{{ old('position') }}"
                    ...
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="fb" type="text" name="fb" value="{{ old('fb') }}"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="twitter" type="text" name="twitter" value="{{ old('twitter') }}"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="instagram" type="text" name="instagram" value="{{ old('instagram') }}"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            id="short_description" name="short_description" rows="3" placeholder="Enter a short description">{{ old('short_description') }}</textarea>

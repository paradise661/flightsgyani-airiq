    ...
    <div class="col-md-12">
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-gray-800">Add New Page</h3>
                </div>
                <!-- Back Button -->
                <div class="flex-none">
            ...
            <!-- Form Start -->
            <form id="form" role="form" action="{{ route('v2.admin.pages.store') }}" method="POST"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            id="description" name="description" rows="4" placeholder="Enter detailed description">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="text-sm text-red-500">*{{ $message }}</span>
                        @enderror
                    </div>

    ...
    <div class="col-md-12">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-gray-800">Add New Sector</h3>
                </div>
            ...
            <!-- form start -->
            <form id="form" role="form" action="{{ route('v2.admin.domestic.sectors.store') }}" method="POST">
                @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="code">Code<span
                                    class="text-red-500">*</span></label>
                            <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="code" type="text" name="code" value="{{ old('code') }}">
                            @if ($errors->has('code'))

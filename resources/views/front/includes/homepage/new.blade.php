            ...
            <div class="px-8">
                <form id="search_box" action="{{ route('flight.search') }}" method="POST">
                    ...
                    <div id="international-tab" role="tabpanel" aria-labelledby="international-item-tab">
                        <!-- Trip Type Dropdown  -->
                        <div class="absolute top-0 z-50 bg-white rounded-md">
                            <div class="relative">
                                <select
                        ...
                        <div class="mt-3">
                            ...
                            <div class="search-wrap oneTwoWayLayout w-full items-center bg-white rounded-md">
                                <div class="flex justify-items-center items-center">
                                    ...
                                    <div class="search-col primary-intl-search px-4">
                                        <button
                                            class="bg-secondary py-3 w-full text-xl text-white font-semibold rounded-md "
                                            type="submit">
                                            SEARCH
                                        </button>
                                    </div>

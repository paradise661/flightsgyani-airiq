...
<head>
    ...
    <title>{{ $ticketDetails->company_name ?? 'FLIGHTS GYANI PVT LTD' }}</title>
</head>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tbody>
                    <tr>
                        ...
                        <td
                            style="padding:10px ;font-family:Lato, Helvetica, Arial, sans-serif; text-align:right;width:50%">
                            <div
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <b>Date of
                                                                            Issue: </b>
                                                                        {{ $booking->created_at ? date('M d, Y', strtotime($booking->created_at ?? '')) : '' }}
                                                                    </div>
                                                                    <div
                                                                        style="margin-top:5px; font-family:Lato, Helvetica, Arial, sans-serif;font-size:14px;line-height:1;text-align:left;color:#16161d;">
                                                                        <strong>Booking
                                                                            Reference:
                                                                        </strong>{{ $booking->booking_code ?? '' }}
                                                                    </div>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <strong>Passenger(s)
                                                                                    Information
                                                                                    ({{ $flight->flight_type == 'O' ? 'Outbound' : 'Inbound' }})
                                                                                </strong>
                                                                            </div>
                                                                        </td>
                                                                        <td align="right"
                                                                            style="font-size:0px;float: right;padding:15px;padding-bottom:0;word-break:break-word;">
                                                                            <div
                                                                                style="font-family:Lato, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:right;color:#16161d;">
                                                                                PNR:
                                                                                {{ $flight->pnr_no ?? '' }}
                                                                            </div>
                                                                        </td>
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr
                                                                                        ...
                                                                                        <th
                                                                                            style="border:1px solid #0f0f0f;padding: 0 15px;">
                                                                                            Passenger
                                                                                            Name
                                                                                        </th>
                                                                                        <th
                                                                                    ...
                                                                                    @if ($booking->flightTicket->count() > 0)
                                                                                        @foreach ($booking->flightTicket as $ticket)
                                                                                            @if ($flight->pnr_no == $ticket->pnr_no)
                                                                                                <tr>
                                                                                                    <td
                                                                                                        style="border:1px solid #0f0f0f;text-align:center; padding: 0 15px;">
                                                                                                        {{ $ticket->first_name }}
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            <img class="img img-fluid"
                                                                                                {{-- src="{{ asset('uploads/domestic/airlines/' . $airData[$flight->airline]) }}" --}}
                                                                                                src="{{ public_path('uploads/domestic/airlines/' . $airData[$flight->airline]) }}"
                                                                                                alt=""
                                                                                                style="width: 50px;">
                                                                                            <br>
                                                                                            {{ $flight->flight_no }}
                                                                                        ...
                                                                                        <td
                                                                                            ...
                                                                                            <br>
                                                                                            {{ $flight->flight_class_code }}
                                                                                            <br>
                                                                                            <b>Ticket Type
                                                                                                :</b>
                                                                                            <br>
                                                                                            {{ $flight->refundable == 'F' ? 'Non-Refundable' : 'Refundable' }}
                                                                                            <br>
                                                                                            <br>
                                                                                        </td>
                                                                                    </tr>

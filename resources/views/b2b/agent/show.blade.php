...
@section('content')
    <div class="flex justify-between items-center mb-4">
        <div class="flex-1">
            <h3 class="text-lg font-semibold text-gray-800">Agent Details</h3>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">NPR: <span
                        class="text-green-600">{{ remainingBalance($agent->id, 'NPR') }}</span></p>
                <p class="text-sm text-gray-500">USD: <span
                        class="text-green-600">{{ remainingBalance($agent->id, 'USD') }}</span></p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                <h5 class="font-semibold text-xl text-gray-800">{{ $agent->name }}</h5>
                <p class="text-sm text-gray-500">{{ $agent->email }}</p>
                <p class="text-sm text-gray-500">{{ $agent->phonenumber }}</p>
            </div>
        </div>

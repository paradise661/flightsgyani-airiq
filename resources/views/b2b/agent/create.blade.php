...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <!-- form start -->
            <form id="form" role="form" action="{{ route('v2.admin.agents.store') }}" method="POST">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @if ($errors->has('pan_vat_number'))
                                <i class="text-sm text-red-500">*{{ $errors->first('pan_vat_number') }}</i>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm"
                                id="phonenumber" type="text" name="phonenumber" value="{{ old('phonenumber') }}">

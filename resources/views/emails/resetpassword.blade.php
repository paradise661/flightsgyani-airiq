...
<head>
    ...
    <style>
        ...
        /* New, smaller, and more elegant reset button */
        .reset-button {
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>We have received a request to reset your password for your account. If you did not make this request, you
                can safely ignore this email.</p>

            <p>Please click the link below to reset your password:</p>

            <a href="{{ route('password.reset', ['token' => $token, 'email' => $email]) }}" class="reset-button">Reset Password</a>

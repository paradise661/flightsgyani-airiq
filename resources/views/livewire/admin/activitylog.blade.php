                ...
                <form class="flex items-center flex-wrap gap-4" wire:submit.prevent="applyFilters">
                    ...
                    <div class="flex flex-col">
                        <label class="mb-1 text-sm font-medium text-gray-700 dark:text-white" for="from-date">Date
                            Range</label>
                        <input
                            class="flatpicker py-2 px-4 w-80 border border-gray-300 rounded-lg shadow-sm text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-white"
        ...
        <div class="inline-block align-middle w-full bg-white rounded-lg shadow-md">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-neutral-900 dark:divide-neutral-700">
                        ...
                        @foreach ($logs as $key => $log)
                            <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700 transition duration-200 ease-in-out">
                                ...
                                {{-- <td class="py-3 px-6 text-sm text-right flex justify-end">
                                    <form action="{{ route('v2.admin.activitylogs.delete', $log->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button
                    ...
                    @else
                        <tr>
                            <td class="py-6 text-center text-gray-500 dark:text-neutral-400" colspan="4">

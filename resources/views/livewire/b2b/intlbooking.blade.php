            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                <thead class="bg-gray-100 dark:bg-neutral-800">
                    <tr>
                        ...
                        <th scope="col"
                            class="py-3 px-6 text-right text-sm font-medium text-gray-600 dark:text-neutral-200">
                            Action
                        </th>
                    </tr>
                </thead>
                        ...
                        @foreach ($bookings as $key => $booking)
                            <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700 transition duration-200 ease-in-out">
                                ...
                                <td class="py-3 px-6 text-sm text-right flex justify-end">
                                    <a href="{{ route('b2b.agent.view.flight.booking', $booking->booking_code) }}"
                                        class="px-4 py-1 mr-2 text-white bg-green-600 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 transition duration-200 ease-in-out text-sm">
                                        View
                                    </a>
                                    {{-- @can('delete booking')

...
We would love for you to contribute to Cropper.js and help make it even better than it is today! As a contributor, here
...
on [Stack Overflow](https://stackoverflow.com/questions/tagged/cropperjs) where the questions should be tagged with
tag `cropperjs`.
...
our [GitHub Repository](https://github.com/fengyuanchen/cropperjs). Even better, you
...
our [GitHub Repository](https://github.com/fengyuanchen/cropperjs). If you would like to *implement* a new feature,
...
Before you submit an issue, please search the [issue tracker](https://github.com/fengyuanchen/cropperjs/issues), maybe
an issue for your problem already exists and the discussion might inform you of workarounds readily available.
...
1. Search [GitHub](https://github.com/fengyuanchen/cropperjs/pulls) for an open or closed PR that relates to your

...
class MarkupController extends Controller
{
    ...
    public function index()
    {
        ...
        activityLog('viewed markups');

        return view('admin.v2.intlflights.markups.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.v2.intlflights.markups.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.v2.intlflights.markups.edit', ['markup' => $markup, 'np' => $np_data, 'us' => $us_data]);
    }
    ...
    public function update(MarkupStoreRequest $request, $id)
    {
        ...
        activityLog('updated markup');

        return redirect()->route('v2.admin.markups.index')->with('success', 'Markup updated successfully.');
    }

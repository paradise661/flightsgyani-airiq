...
class MarkupService
{
    ...
    public function getMarkupMatchingAll()
    {
        ...
        $markup = Markup::where('airline', $this->airline)
    ...
    {
        $air_sec_trip = Markup::where('airline', $this->airline)
            ->where('origin', $this->origin)
            ->where('destination', $this->destination)
            ...
            ->first();
        $air_sec_class = Markup::where('airline', $this->airline)
            ->where('origin', $this->origin)
            ->where('destination', $this->destination)
            ->where($this->antiType, false)
            ->where('trip_type', 'A')
            ...
            ->orderBy('priority', 'asc')
            ->first();
        $air_trip_class = Markup::where('airline', $this->airline)
            ->where('trip_type', $this->trip_type)
        ...
        $sec_trip_class = Markup::where('origin', $this->origin)
            ->where('destination', $this->destination)
            ->where('trip_type', $this->trip_type)
            ->where('airline', null)
            ->where(function ($query) {
    ...
    {
        $airline_sector = Markup::where('origin', $this->origin)
            ->where('destination', $this->destination)
        ...
        $airline_trip = Markup::where('airline', $this->airline)
            ->where('origin', null)
            ->where('destination', null)
            ->where('status', true)
            ->where('trip_type', $this->trip_type)
        ...
        $airline_class = Markup::where('airline', $this->airline)
            ->where('origin', null)
            ->where('destination', null)
            ->where('trip_type', 'A')
            ->where(function ($query) {
        ...
        $trip_sector = Markup::where('origin', $this->origin)
            ->where('destination', $this->destination)
            ->where('airline', null)
            ->where('status', true)
            ->where('trip_type', $this->trip_type)
            ...
            ->orderBy('priority')
            ->first();
        $trip_class = Markup::where('origin', null)
            ->where('destination', null)
            ->where('airline', null)
            ->where('status', true)
            ->where($this->type, true)
        ...
        $class_sector = Markup::where('origin', $this->origin)
            ->where('destination', $this->destination)
            ->where('airline', null)
            ->where('trip_type', 'A')
            ->where(function ($query) {
    ...
    {
        //        dd($this->search->destination);
        $markup = Markup::where('origin', $this->origin)
            ->where('destination', $this->destination)
            ->where('airline', null)
    ...
    {
        $markup = Markup::where('trip_type', $this->trip_type)
            ->where('airline', null)
            ->where('origin', null)
            ->where($this->type, true)
            ->where('destination', null)
    ...
    {
        $markup = Markup::where('origin', null)
            ->where('destination', null)
            ->where('trip_type', 'A')
            ->where('airline', null)
            ->where(function ($query) {
    ...
    {
        $markup = Markup::where('airline', null)
            ->where('origin', null)
            ->where('destination', null)
            ->where('trip_type', 'A')
            ->where('status', true)
